...
pos_tweets = read_tweets('happy.txt', '1')
neg_tweets = read_tweets('sad.txt', '0')
...
test_tweets = read_tweets('IBM2017-11-02.txt', '1')
# test_tweets.extend(read_tweets('sad_test.txt', '0'))
total = accuracy = float(len(test_tweets))

result = 0
num = 0
for tweet in test_tweets:
    result += int(classify_tweet(tweet[0]))
    num += 1
    print (num)
...
print('Total accuracy: %f%%.' % (result / num * 100))
